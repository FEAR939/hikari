          ...
          <div class="space-y-2">
            {settingsTree.map((setting, index: number) =>
              bind(
                ...
                (value) => (
                  <div
                    class={`flex items-center gap-1 w-full ${value === index ? "text-neutral-200" : "text-neutral-500"} hover:text-neutral-200 transition-colors duration-150 cursor-pointer`}
