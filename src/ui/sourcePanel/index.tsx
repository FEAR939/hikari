...
export function SourcePanel({
  ...
  const container = (
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center transition-all duration-150 ease-in-out opacity-0">
      <div
        class="relative max-w-full w-[70rem] aspect-video p-6 space-y-4 overflow-y-scroll bg-[#171717] backdrop-blur-xl border border-[#222222] rounded-3xl transition-all duration-150 ease-in-out scale-75"
