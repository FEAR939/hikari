...
export default function AccountSettings() {
  ...
  avatarEdit.className =
    "absolute right-0 bottom-0 bg-white text-black rounded-full size-6 grid place-items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300";
