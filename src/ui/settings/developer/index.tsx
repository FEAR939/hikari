  ...
  const page = (
    <div class="h-full w-full space-y-4 overflow-y-scroll">
      ...
      {settings.map((setting) => (
        <div class="bg-[#1d1d1d] border border-[#222222] rounded-2xl h-fit w-full p-4 flex gap-2">
          ...
          <div class="flex items-center">
            {setting.type === "button" && (
              <div
                class="px-4 py-2 w-fit text-sm bg-neutral-200 hover:bg-neutral-400 text-black rounded-full cursor-pointer transition-colors duration-150 text-nowrap"
                onClick={() => {
                  setting.onclick?.();
                }}
              >
