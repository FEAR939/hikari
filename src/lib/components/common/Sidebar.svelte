...
>
    ...
    <div class="space-y-2">
        ...
        <a
            class={`block p-2 rounded-xl cursor-pointer ${page.url.pathname === "/search/" ? "text-white" : "text-neutral-700"} hover:bg-white/10 focus-within:bg-white/10 transition-colors duration-150 outline-hidden`}
            href="/search"
            aria-label="search"
        >
            <svg
